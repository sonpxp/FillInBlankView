...
private lateinit var tvResult: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupListeners()
        loadWords()
        setupWithCustomDrawables()
    }

    private fun setupWithCustomDrawables() {
        // Sử dụng drawable resources như yêu cầu
        wordArrangementView.apply {
            ...
            // Nền cho placeholder (tuỳ chọn)
             setPlaceholderBackground(R.drawable.img_box_grey)

            // Màu chữ theo màu nền
            setAvailableTextColorRes(R.color.grey_text_color)  // Màu chữ cho nền xám
            setArrangedTextColorRes(R.color.cyan_text_color)   // Màu chữ cho nền cyan

            // Text style - bold
            setTextStyle(isBold = true)
        }
    }
